...
public class UserAuthentication
{
    ...
    public boolean checkGuestUser(User user) //working
    {
    ...
    public boolean checkAdminUser(User user) //working
    {
        Connection connection = Database.getConnection();
        Statement statement = null;int check = 0;
        try{
    ...
    public void changePassword(User user) //working
    {
        Connection connection = Database.getConnection();
    ...
    public void signUp(User user) //working
    {
        Connection connection = Database.getConnection();
        Statement statement = null;
        try{
    ...
    public void forgetpassword(User user) //working
    {
        Connection connection = Database.getConnection();
        Statement statement = null;
        try{
